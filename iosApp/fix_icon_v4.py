...
# SITA Seal source (from SITACardMaster resources)
...
make_icon(source_sita, dest_master, logo_target_size=800)

# Target for SITA Cardent (DeviSoft) - User wants same SITA seal
...
make_icon(source_sita, dest_cardent, logo_target_size=800)
