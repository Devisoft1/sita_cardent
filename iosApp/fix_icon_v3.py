...
def make_icon(source_path, target_path, logo_target_size=800):
...
# SITA Card Master - SITA Seal (Refined size to avoid clipping)
source_master = "/Users/shah/AndroidStudioProjects/sita_apps/sita_card_master/composeApp/src/androidMain/res/drawable/sita_logo.png"
...
make_icon(source_master, dest_master, logo_target_size=800)

# SITA Cardent (DeviSoft) - Correct DeviSoft Logo (Safe size)
source_cardent = "/Users/shah/AndroidStudioProjects/sita_apps/sita_cardent/composeApp/src/androidMain/res/drawable/devisoft_logo.png"
...
make_icon(source_cardent, dest_cardent, logo_target_size=800)
